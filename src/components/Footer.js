...
function Footer() {
  return (
        ...
        <div className="row">
            ...
            <div className="col-md-6 mb-md-0 mb-1 text-center">
                ...
                <ul className="list-unstyled d-inline">
                    <li className="d-inline p-2 text-decoration-none"><a href="#!">Facebook <TiSocialFacebookCircular/></a></li>
                    <li className="d-inline p-2"><a href="#!">Twitter <VscTwitter/></a></li>
                    <li className="d-inline p-2"><a href="#!">Instagram <TiSocialInstagram/></a></li>
                    <li className="d-inline p-2"><a href="#!">LinkedIn <TiSocialLinkedinCircular/></a></li>
                    <li className="d-inline p-2"><a href="#!"> Github <VscGithub/></a></li>
    ...
    <div className="footer-copyright text-center py-1 text-light pb-4 pt-2">© 2022 Copyright:
        <a href="#"> <b>SignatureCuisine.com</b></a>
    </div>
